...
public interface IPackages {
	...
	@Produces(MediaType.TEXT_HTML)
	public abstract RenderedUI addServiceView(@PathParam(IWebPath.VAR_NAME) String pname);
	...
	@Produces(MediaType.TEXT_HTML)
	public abstract RenderedUI newServiceView(@PathParam(IWebPath.VAR_NAME) String pname);
	...
	@Produces(MediaType.TEXT_HTML)
	public abstract RenderedUI deleteServiceView(@PathParam(IWebPath.VAR_NAME) String pname, @PathParam(IWebPath.VAR_SERVICE) String sname);
	...
	@Produces(MediaType.TEXT_HTML)
	public abstract RenderedUI addPackageView(@PathParam(IWebPath.VAR_NAME) String pname, @PathParam(IWebPath.VAR_VERSION) Long versionId);
