...
public class ConfigValueImpl implements IConfigValue {
    ...
    @Override
    @Transactional
    public Collection<ConfigValue> get(String template) {
    ...
    @Override
    public Collection<ConfigValue> getUnstacked(String template) {
        RESTAssert.assertNotEmpty(template);
    ...
    @Override
    @Transactional
    public Collection<ConfigValue> get(String template, String service) {
        RESTAssert.assertNotEmpty(template);
        RESTAssert.assertNotEmpty(service);
        Collection<ConfigValue> result = this.get(template);
