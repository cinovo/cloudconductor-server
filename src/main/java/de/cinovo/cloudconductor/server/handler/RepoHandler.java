...
public class RepoHandler {
	...
	public ERepoMirror createEntity(RepoMirror mirror) throws WebApplicationException {
		...
		emirror = this.fillFields(emirror, mirror);
	...
	private ERepoMirror fillFields(ERepoMirror emirror, RepoMirror mirror) {
		ERepo erepo = this.repoDAO.findByName(mirror.getRepo());
		if(erepo == null) {
			return null;
		}
