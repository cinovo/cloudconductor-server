...
public interface IServiceDefaultStateDAO extends IEntityDAO<EServiceDefaultState, Long> {
	...
	/**
	 * @param serviceId     the service service id
	 * @param templateId the template id
	 * @return the default service state
	 */
	EServiceDefaultState findByServiceAndTemplate(Long serviceId, Long templateId);
	
	/**
	 * @param templateId the template id
	 * @return list off default services
	 */
	List<EServiceDefaultState> findByTemplate(Long templateId);
}
